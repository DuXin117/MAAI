function [Temperatureout, Vaporout, xcout, Liqout, Holdout, EnthalLout, EnthalVout, LN, HN, LCO, Ttrack1, Ttrack2, yout, Pfra, PI_sensors] = FractionatoriV2(xfra, ufra, xc, MV, products, yin, Xfil, dist, actors)
